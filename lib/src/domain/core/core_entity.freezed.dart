...
/// Adds pattern-matching-related methods to [CoreEntity].
extension CoreEntityPatterns<T extends Object> on CoreEntity<T> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CoreEntity<T> value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CoreEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CoreEntity<T> value)  $default,){
final _that = this;
switch (_that) {
case _CoreEntity():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CoreEntity<T> value)?  $default,){
final _that = this;
switch (_that) {
case _CoreEntity() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( EntityId id,  String name,  String? description,  DateTime createdAt,  DateTime updatedAt,  String schemaVer,  EntityStatus status,  Map<String, Object> meta,  UserAction owner,  UserAction creator,  UserAction modifier,  T? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CoreEntity() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.updatedAt,_that.schemaVer,_that.status,_that.meta,_that.owner,_that.creator,_that.modifier,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EntityId id,  String name,  String? description,  DateTime createdAt,  DateTime updatedAt,  String schemaVer,  EntityStatus status,  Map<String, Object> meta,  UserAction owner,  UserAction creator,  UserAction modifier,  T? data)  $default,) {final _that = this;
switch (_that) {
case _CoreEntity():
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.updatedAt,_that.schemaVer,_that.status,_that.meta,_that.owner,_that.creator,_that.modifier,_that.data);}
}
